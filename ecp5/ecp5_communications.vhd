    ...
    package uart_comm_pkg is new work.serial_protocol_generic_pkg
    generic map(serial_rx_data_output_record => work.uart_rx_pkg.uart_rx_data_output_group
                ,serial_tx_data_input_record  => work.uart_tx_pkg.uart_tx_data_input_group
                ,serial_tx_data_output_record => work.uart_tx_pkg.uart_tx_data_output_group
                --------------------------------
                ,serial_rx_data_is_ready => work.uart_rx_pkg.uart_rx_data_is_ready
                --------------------------------
                ,get_serial_rx_data => work.uart_rx_pkg.get_uart_rx_data
                --------------------------------
                ,init_serial => work.uart_tx_pkg.init_uart
                --------------------------------
                ,transmit_8bit_data_package => work.uart_tx_pkg.transmit_8bit_data_package
                --------------------------------
                ,serial_tx_is_ready  => work.uart_tx_pkg.uart_tx_is_ready
                ,g_data_bit_width    => work.fpga_interconnect_pkg.init_fpga_interconnect.data'length
                ,g_address_bit_width => work.fpga_interconnect_pkg.init_fpga_interconnect.address'length
            );
...
entity fpga_communications is
    generic(
                --package fpga_bus_pkg is new work.fpga_interconnect_generic_pkg generic map(<>)
    ...
    port (
        ...
        bus_to_communications : in work.fpga_interconnect_pkg.fpga_interconnect_record;
        bus_from_communications : out  work.fpga_interconnect_pkg.fpga_interconnect_record
    );
...
architecture rtl of fpga_communications is
   ...
   -- use fpga_bus_pkg.all;
   use work.fpga_interconnect_pkg.all;


    use work.uart_comm_pkg.all;
